...
describe("String class Extension", function() {
  ...
  describe("Returns the letter in alternate case, starting with lowercase", function() {
    it("should return alternate case when the string is uppercase", function() {
      expect('IS REGEX VERY EASY TO IMPLEMENT?'.alternateCase()).toEqual('iS ReGeX VeRy eAsY To iMpLeMeNt?');
    });

    it("should return alternate when all cases been lowercase  ", function() {
      expect('regex is simply regular expressions'.alternateCase()).toEqual('rEgEx iS SiMpLy rEgUlAr eXpReSsIoNs');
    });
